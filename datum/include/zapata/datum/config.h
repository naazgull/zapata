/* include/zapata/datum/config.h.  Generated from config.h.in by configure.  */
/* include/zapata/datum/config.h.in.  Generated from configure.ac by autoheader.  */

#include <zapata/datum/unconfig.h>
...
/* Name of package */
#define PACKAGE "zapata-datum"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "n@zgul <naazgull@dfz.pt>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "zapata-datum"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "zapata-datum 0.9.1-4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zapata-datum"
