...
class token_provider {
  public:
    ...
    virtual auto retrieve_client(std::string const& _client_id,
                                 std::string const& _client_secret) -> zpt::json = 0;
...
class server {
  public:
    ...
    virtual auto authorize(zpt::performative _performative,
                           zpt::json _envelope,
                           zpt::json _opts) -> zpt::json;
    virtual auto authorize(std::string const& _topic,
                           zpt::json _envelope,
                           zpt::json _roles_needed) -> zpt::json;
    virtual auto token(zpt::performative _performative,
                       zpt::json _envelope,
                       zpt::json _opts) -> zpt::json;
    virtual auto refresh(zpt::performative _performative,
                         zpt::json _envelope,
                         zpt::json _opts) -> zpt::json;
    virtual auto validate(zpt::performative _performative,
                          zpt::json _envelope,
                          zpt::json _opts) -> zpt::json;
