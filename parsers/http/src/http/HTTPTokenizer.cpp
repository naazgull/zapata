// Generated by Bisonc++ V6.02.05 on Mon, 11 Nov 2019 00:34:31 +0000
...
PI_ const s_productionInfo[] = {
    ...
    { 269, 10 }, // 1: exp (METHOD) ->  METHOD #0001 SPACE URL #0002 params SPACE HTTP_VERSION
                 // headers rest
    { 270, 0 },  // 2: #0001 ->  <empty>
    { 272, 0 },  // 3: #0002 ->  <empty>
    { 269, 10 }, // 4: exp (HTTP_VERSION) ->  HTTP_VERSION #0003 SPACE STATUS #0004 SPACE STRING
                 // #0005 headers rest
    { 275, 0 },  // 5: #0003 ->  <empty>
    { 276, 0 },  // 6: #0004 ->  <empty>
    { 277, 0 },  // 7: #0005 ->  <empty>
