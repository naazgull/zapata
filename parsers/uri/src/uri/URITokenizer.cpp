// Generated by Bisonc++ V6.03.00 on Sat, 16 May 2020 16:54:56 -44156754
...
PI_ const s_productionInfo[] = {
    ...
    { 265, 4 }, // 1: exp ->  scheme server path params
    { 265, 3 }, // 2: exp ->  scheme path params
    { 266, 0 }, // 3: scheme ->  <empty>
    { 266, 3 }, // 4: scheme (STRING) ->  STRING #0001 DOUBLE_DOT
    { 270, 0 }, // 5: #0001 ->  <empty>
    { 267, 6 }, // 6: server (SLASH) ->  SLASH SLASH user STRING #0002 port
    { 273, 0 }, // 7: #0002 ->  <empty>
    { 267, 5 }, // 8: server (SLASH) ->  SLASH SLASH STRING #0003 port
    { 274, 0 }, // 9: #0003 ->  <empty>
    { 271, 3 }, // 10: user (STRING) ->  STRING #0004 AT
    { 275, 0 }, // 11: #0004 ->  <empty>
    { 272, 0 }, // 12: port ->  <empty>
    { 272, 2 }, // 13: port (DOUBLE_DOT) ->  DOUBLE_DOT STRING
    { 268, 0 }, // 14: path ->  <empty>
    { 268, 1 }, // 15: path (SLASH) ->  SLASH
    { 268, 4 }, // 16: path (SLASH) ->  SLASH STRING #0005 path
    { 276, 0 }, // 17: #0005 ->  <empty>
    { 269, 0 }, // 18: params ->  <empty>
    { 269, 2 }, // 19: params (QMARK) ->  QMARK paramslist
    { 277, 4 }, // 20: paramslist (STRING) ->  STRING #0006 EQ paramvalue
    { 278, 0 }, // 21: #0006 ->  <empty>
    { 277, 6 }, // 22: paramslist (E) ->  paramslist E STRING #0007 EQ paramvalue
    { 280, 0 }, // 23: #0007 ->  <empty>
    { 279, 0 }, // 24: paramvalue ->  <empty>
    { 279, 3 }, // 25: paramvalue (STRING) ->  STRING #0008 function_parameters
    { 282, 0 }, // 26: #0008 ->  <empty>
    { 281, 0 }, // 27: function_parameters ->  <empty>
    { 281,
...
SR_ const s_39[] = {
    { { REQ_DEF }, { 3 } },
    { { 281 }, { 41 } }, // function_parameters
    { { 264 }, { 42 } }, // FUNCTION_PARAM
    { { 0 }, { -27 } },
};
