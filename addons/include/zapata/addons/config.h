/* include/zapata/addons/config.h.  Generated from config.h.in by configure.  */
/* include/zapata/addons/config.h.in.  Generated from configure.ac by autoheader.  */

#include <zapata/addons/unconfig.h>
...
/* Name of package */
#define PACKAGE "zapata-addons"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "n@zgul <naazgull@dfz.pt>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "zapata-addons"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "zapata-addons 0.9.1-1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zapata-addons"
