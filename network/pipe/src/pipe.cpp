...
auto
zpt::net::transport::pipe_stream::process_incoming_request(zpt::basic_stream& _stream) const
  -> zpt::message {
...
auto
zpt::net::transport::pipe_stream::process_incoming_reply(zpt::basic_stream& _stream) const
  -> zpt::message {
    expect(_stream.transport() == "pipe", "Stream underlying transport isn't 'pipe'");
    auto _message = zpt::make_message<zpt::json_message>();
    _stream >> std::noskipws >> _message;
