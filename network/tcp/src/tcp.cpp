...
auto zpt::net::transport::tcp::process_incoming_request(zpt::basic_stream& _stream) const -> zpt::message {
...
auto zpt::net::transport::tcp::process_incoming_reply(zpt::basic_stream& _stream) const -> zpt::message {
    expect(_stream.transport() == "tcp", "Stream underlying transport isn't 'tcp'");
    auto _message = zpt::make_message<zpt::json_message>();
    _stream >> std::noskipws >> _message;
    return _message;
