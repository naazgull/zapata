...
auto zpt::apps::ResourceOwners::get(std::string _topic,
				    zpt::ev::emitter _emitter,
				    zpt::json _identity,
				    zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
...
auto zpt::apps::ResourceOwners::query(std::string _topic,
				      zpt::json _filter,
				      zpt::ev::emitter _emitter,
				      zpt::json _identity,
				      zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::ResourceOwners::insert(std::string _topic,
				       zpt::json _document,
				       zpt::ev::emitter _emitter,
				       zpt::json _identity,
				       zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::ResourceOwners::save(std::string _topic,
				     zpt::json _document,
				     zpt::ev::emitter _emitter,
				     zpt::json _identity,
				     zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::ResourceOwners::set(std::string _topic,
				    zpt::json _document,
				    zpt::ev::emitter _emitter,
				    zpt::json _identity,
				    zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::ResourceOwners::remove(std::string _topic,
				       zpt::ev::emitter _emitter,
				       zpt::json _identity,
				       zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
...
auto zpt::apps::Applications::get(std::string _topic,
				  zpt::ev::emitter _emitter,
				  zpt::json _identity,
				  zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
	...
	zpt::json _d_admin = _emitter->route(
	    ...
	    {"headers",
	     ...
	     "params",
	     (_envelope["params"] + {"app_id", std::string(_r_data["id"]), "role", "m/admin/i"})})["payload"];
	_r_data << "admin" << (_d_admin["elements"]->type() == zpt::JSArray ? _d_admin["elements"][0] : _d_admin);
	zpt::json _d_token = _emitter->route(zpt::ev::Get,
	...
	_r_data << "users"
		<< (_d_users["elements"]->type() == zpt::JSArray ? _d_users["elements"] : {zpt::array, _d_users});

	return _r_data;
}

auto zpt::apps::Applications::query(std::string _topic,
				    zpt::json _filter,
				    zpt::ev::emitter _emitter,
				    zpt::json _identity,
				    zpt::json _envelope) -> zpt::json {
	...
	if (_r_data["elements"]->type() == zpt::JSArray) {
		for (auto _d_element : _r_data["elements"]->arr()) {
			...
			_d_element << "admin" << (_d_admin["elements"]->type() == zpt::JSArray ? _d_admin["elements"][0]
											       : _d_admin);
		}
	}
	zpt::json _d_token =
...
auto zpt::apps::Applications::insert(std::string _topic,
				     zpt::json _document,
				     zpt::ev::emitter _emitter,
				     zpt::json _identity,
				     zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::Applications::save(std::string _topic,
				   zpt::json _document,
				   zpt::ev::emitter _emitter,
				   zpt::json _identity,
				   zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::Applications::set(std::string _topic,
				  zpt::json _document,
				  zpt::ev::emitter _emitter,
				  zpt::json _identity,
				  zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::Applications::remove(std::string _topic,
				     zpt::ev::emitter _emitter,
				     zpt::json _identity,
				     zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
...
auto zpt::apps::MyApplications::get(std::string _topic,
				    zpt::ev::emitter _emitter,
				    zpt::json _identity,
				    zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
	...
	zpt::json _d_channels =
	    _emitter->route(zpt::ev::Get,
			    ...
			    {"headers",
			     ...
			     "params",
			     (_envelope["params"] + {"app_id", std::string(_r_data["id"])})})["payload"];
	_r_data << "channels" << (_d_channels["elements"]->type() == zpt::JSArray ? _d_channels["elements"]
										  : {zpt::array, _d_channels});

	return _r_data;
}

auto zpt::apps::MyApplications::query(std::string _topic,
				      zpt::json _filter,
				      zpt::ev::emitter _emitter,
				      zpt::json _identity,
				      zpt::json _envelope) -> zpt::json {
	...
	_r_data = _emitter->route(zpt::ev::Get,
				  ...
				  {"headers",
				   ...
				   "params",
				   (_envelope["params"] + {"namespace", "m/engie/i"})})["payload"];
	_r_data << "payload" << (_r_data["payload"]["elements"]->ok() ? _r_data["payload"]
...
auto zpt::apps::MyApplications::insert(std::string _topic,
				       zpt::json _document,
				       zpt::ev::emitter _emitter,
				       zpt::json _identity,
				       zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyApplications::save(std::string _topic,
				     zpt::json _document,
				     zpt::ev::emitter _emitter,
				     zpt::json _identity,
				     zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyApplications::set(std::string _topic,
				    zpt::json _document,
				    zpt::ev::emitter _emitter,
				    zpt::json _identity,
				    zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyApplications::remove(std::string _topic,
				       zpt::ev::emitter _emitter,
				       zpt::json _identity,
				       zpt::json _envelope) -> zpt::json {
	zpt::json _r_data;
...
auto zpt::apps::MyUsers::get(std::string _topic, zpt::ev::emitter _emitter, zpt::json _identity, zpt::json _envelope)
    -> zpt::json {
	zpt::json _r_data;
	zpt::connector _c = _emitter->connector("dbms.redis.zpt.apps");
...
auto zpt::apps::MyUsers::query(std::string _topic,
			       zpt::json _filter,
			       zpt::ev::emitter _emitter,
			       zpt::json _identity,
			       zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyUsers::insert(std::string _topic,
				zpt::json _document,
				zpt::ev::emitter _emitter,
				zpt::json _identity,
				zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyUsers::save(std::string _topic,
			      zpt::json _document,
			      zpt::ev::emitter _emitter,
			      zpt::json _identity,
			      zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyUsers::set(std::string _topic,
			     zpt::json _document,
			     zpt::ev::emitter _emitter,
			     zpt::json _identity,
			     zpt::json _envelope) -> zpt::json {
...
auto zpt::apps::MyUsers::remove(std::string _topic, zpt::ev::emitter _emitter, zpt::json _identity, zpt::json _envelope)
    -> zpt::json {
	zpt::json _r_data;
...
auto zpt::apps::MyUsers::remove(std::string _topic,
				zpt::json _filter,
				zpt::ev::emitter _emitter,
				zpt::json _identity,
				zpt::json _envelope) -> zpt::json {
