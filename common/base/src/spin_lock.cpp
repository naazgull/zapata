...
auto zpt::locks::spin_lock::count_shared() -> long { return this->__shared_access->load(); }

auto zpt::locks::spin_lock::count_exclusive() -> long { return this->__exclusive_access->load(); }

auto zpt::locks::spin_lock::count_shared_acquired_by_thread() -> long {
    auto& _count = zpt::locks::spin_lock::__acquired_spins[this];
    return _count > 0 ? _count : 0;
}

auto zpt::locks::spin_lock::count_exclusive_acquired_by_thread() -> long {
    auto& _count = zpt::locks::spin_lock::__acquired_spins[this];
    return _count < 0 ? -_count : 0;
}

auto zpt::locks::spin_lock::acquire_shared() -> zpt::locks::spin_lock& {
    auto& _count = zpt::locks::spin_lock::__acquired_spins[this];
...
auto zpt::locks::spin_lock::acquire_exclusive() -> zpt::locks::spin_lock& {
    auto& _count = zpt::locks::spin_lock::__acquired_spins[this];
...
auto zpt::locks::spin_lock::release_shared() -> zpt::locks::spin_lock& {
...
auto zpt::locks::spin_lock::release_exclusive() -> zpt::locks::spin_lock& {
    auto _found = zpt::locks::spin_lock::__acquired_spins.find(this);
    expect(_found != zpt::locks::spin_lock::__acquired_spins.end() && _found->second < 0,
           "spin lock not acquired by thread");
    ++_found->second;
...
auto zpt::locks::spin_lock::spin_shared_lock() -> void {
    do {
...
auto zpt::locks::spin_lock::guard::release() -> zpt::locks::spin_lock::guard& {
...
auto zpt::locks::spin_lock::guard::exclusivity() -> zpt::locks::spin_lock::guard& {
...
auto zpt::locks::spin_lock::guard::shareability() -> zpt::locks::spin_lock::guard& {
