...
auto zpt::net::transport::http::process_incoming_request(zpt::basic_stream& _stream) const -> zpt::message {
...
auto zpt::net::transport::http::process_incoming_reply(zpt::basic_stream& _stream) const -> zpt::message {
    expect(_stream.transport() == "http", "Stream underlying transport isn't 'http'");
