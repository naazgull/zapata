/* include/zapata/couchdb/config.h.  Generated from config.h.in by configure.  */
/* include/zapata/couchdb/config.h.in.  Generated from configure.ac by autoheader.  */

#include <zapata/couchdb/unconfig.h>
...
/* Define to 1 if you have the `hicouchdb' library (-lhicouchdb). */
/* #undef HAVE_LIBHICOUCHDB */
...
#define PACKAGE_STRING "zapata-couchdb 0.9.7-1yakkety23"
...
#define PACKAGE_VERSION "0.9.7-1yakkety23"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "0.9.7-1yakkety23"
