...
protected:
    ...
    int     const (*d_dfaBase_)[19];

    static int     const s_dfa_[][19];
    static int     const (*s_dfaBase_[])[19];
...
public:
    ...
    URILexerBase &operator=(URILexerBase const &rhs)    = delete;
...
protected:
    URILexerBase(std::istream &in, std::ostream &out);
    URILexerBase(std::string const &infilename, std::string const &outfilename);
    ~URILexerBase();
...
inline std::ostream &URILexerBase::out()
{
    return *d_out;
}

inline void URILexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void URILexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void URILexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void URILexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &URILexerBase::matched() const
{
    return d_matched;
}

inline std::string const &URILexerBase::filename() const
{
    return d_filename;
}

inline void URILexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t URILexerBase::length() const
{
    return d_matched.size();
}

inline void URILexerBase::leave(int retValue) const
{
    throw as<Leave_>(retValue);
}

inline size_t URILexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void URILexerBase::more()
{
    d_more = true;
}

inline size_t URILexerBase::state_() const
{
    return d_state;
}

inline size_t URILexerBase::get_()
{
    return (this->*d_get)();
}

inline size_t URILexerBase::getInput()
{
    return d_input.get();
}

inline bool URILexerBase::return_()
{
    return d_return;
}

inline void URILexerBase::noReturn_()
{
    d_return = false;
}
