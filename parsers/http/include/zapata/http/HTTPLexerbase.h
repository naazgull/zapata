...
inline void
HTTPLexerBase::push(size_t ch) {
    d_input->reRead(ch);
}

inline void
HTTPLexerBase::push(std::string const& str) {
    d_input->reRead(str, 0);
}

inline std::vector<HTTPLexerBase::StreamStruct> const&
HTTPLexerBase::streamStack() const {
    return d_streamStack;
}

inline void
HTTPLexerBase::setFilename(std::string const& name) {
    d_filename = name;
}

inline void
HTTPLexerBase::setMatched(std::string const& text) {
    d_matched = text;
}

inline std::string const&
HTTPLexerBase::matched() const {
    return d_matched;
}

inline std::string const&
HTTPLexerBase::cwd() const {
    return d_cwd;
}

inline std::string const&
HTTPLexerBase::filename() const {
    return d_filename;
}

inline void
HTTPLexerBase::echo() const {
    *d_out << d_matched;
}

inline size_t
HTTPLexerBase::length() const {
    return d_matched.size();
}

inline void
HTTPLexerBase::leave(int retValue) const {
    throw as<Leave_>(retValue);
}

inline size_t
HTTPLexerBase::lineNr() const {
...
inline size_t
HTTPLexerBase::getInput() {
    return d_input->get();
}

inline bool
HTTPLexerBase::return_() {
    return d_return;
}

inline void
HTTPLexerBase::noReturn_() {
    d_return = false;
}
