/* include/zapata/mongodb/config.h.  Generated from config.h.in by configure.  */
/* include/zapata/mongodb/config.h.in.  Generated from configure.ac by autoheader.  */

#include <zapata/mongodb/unconfig.h>
...
/* Name of package */
#define PACKAGE "zapata-mongodb"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "n@zgul <n@zgul.me>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "zapata-mongodb"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "zapata-mongodb 0.9.7-1yakkety29"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zapata-mongodb"
