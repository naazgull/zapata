...
#ifndef zptFunctionalLexerBASE_H_INCLUDED
#define zptFunctionalLexerBASE_H_INCLUDED
...
class FunctionalLexerBase {
  ...
  private:
    ...
    size_t (FunctionalLexerBase::*d_get)() = &FunctionalLexerBase::getInput;
  ...
  public:
    FunctionalLexerBase(FunctionalLexerBase const& other) = delete;
    FunctionalLexerBase& operator=(FunctionalLexerBase const& rhs) = delete;
  ...
  protected:
    FunctionalLexerBase(std::istream& in, std::ostream& out);
    FunctionalLexerBase(std::string const& infilename, std::string const& outfilename);
    ~FunctionalLexerBase();
  ...
  private:
    ...
    static std::string setCwd(std::string const& filename);
...
inline FunctionalLexerBase::~FunctionalLexerBase() { d_input->close(); }

template<typename ReturnType, typename ArgType>
inline ReturnType constexpr FunctionalLexerBase::as(ArgType value) {
    return static_cast<ReturnType>(value);
}

// $insert startcondimpl
inline FunctionalLexerBase::StartCondition_ constexpr FunctionalLexerBase::SC(int sc) {
...
inline bool constexpr FunctionalLexerBase::available(size_t value) {
