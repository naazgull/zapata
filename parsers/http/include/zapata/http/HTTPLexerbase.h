...
inline size_t HTTPLexerBase::Input::lineNr() const { return d_lineNr; }
inline size_t HTTPLexerBase::Input::nPending() const { return d_deque.size(); }
inline void HTTPLexerBase::Input::setPending(size_t size) {
    d_deque.erase(d_deque.begin(), d_deque.end() - size);
}
inline void HTTPLexerBase::Input::close() {
    delete d_in;
...
inline bool constexpr HTTPLexerBase::available(size_t value) {
...
inline std::vector<HTTPLexerBase::StreamStruct> const& HTTPLexerBase::streamStack() const {
...
inline std::string const& HTTPLexerBase::cwd() const { return d_cwd; }

inline std::string const& HTTPLexerBase::filename() const { return d_filename; }

inline void HTTPLexerBase::echo() const { *d_out << d_matched; }

inline size_t HTTPLexerBase::length() const { return d_matched.size(); }

inline void HTTPLexerBase::leave(int retValue) const { throw as<Leave_>(retValue); }

inline size_t HTTPLexerBase::lineNr() const { return d_input->lineNr(); }

inline void HTTPLexerBase::more() { d_more = true; }

inline size_t HTTPLexerBase::state_() const { return d_state; }

inline size_t HTTPLexerBase::get_() { return (this->*d_get)(); }

inline size_t HTTPLexerBase::getInput() { return d_input->get(); }

inline bool HTTPLexerBase::return_() { return d_return; }

inline void HTTPLexerBase::noReturn_() { d_return = false; }
