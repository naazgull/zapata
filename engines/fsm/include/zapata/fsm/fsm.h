...
class element {
  public:
    ...
    element(zpt::fsm::element const& _rhs);
    element(zpt::fsm::element&& _rhs);
    virtual ~element() = default;

    auto operator=(zpt::fsm::element const& _rhs) -> zpt::fsm::element&;
    auto operator=(zpt::fsm::element&& _rhs) -> zpt::fsm::element&;
    ...
    friend auto operator<<(std::ostream& _os, zpt::fsm::element& _out) -> std::ostream& {
        return _os;
    }
...
class engine : public zpt::pipeline::engine<zpt::fsm::element> {
  public:
    ...
    auto add_transition(std::string _source_state,
                        std::string _pattern,
                        std::function<void(zpt::pipeline::event<zpt::fsm::element>&)> _callback)
      -> zpt::fsm::engine&;
