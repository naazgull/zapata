// Generated by Bisonc++ V6.02.05 on Sat, 09 Nov 2019 18:14:27 +0000
...
// hdr/savedtoken
inline int HTTPTokenizerBase::savedToken_() const
{
    return d_next.first;
}
...
{
    return static_cast<HTTPTokenizerBase::DebugMode_>(
...
// hdr/recovery
inline bool HTTPTokenizerBase::recovery_() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t HTTPTokenizerBase::stackSize_() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t HTTPTokenizerBase::state_() const
{
    return d_state;
}

// hdr/token
inline int HTTPTokenizerBase::token_() const
{
    return d_token;
}

// hdr/vs
inline HTTPTokenizerBase::STYPE_ &HTTPTokenizerBase::vs_(int idx) 
{
