...
// hdr/savedtoken
inline int JSONTokenizerBase::savedToken_() const
{
    return d_next.first;
}
...
{
    return static_cast<JSONTokenizerBase::DebugMode_>(
...
// hdr/recovery
inline bool JSONTokenizerBase::recovery_() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t JSONTokenizerBase::stackSize_() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t JSONTokenizerBase::state_() const
{
    return d_state;
}

// hdr/token
inline int JSONTokenizerBase::token_() const
{
    return d_token;
}

// hdr/vs
inline JSONTokenizerBase::STYPE_ &JSONTokenizerBase::vs_(int idx) 
{
