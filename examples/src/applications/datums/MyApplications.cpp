...
auto
zpt::apps::datums::MyApplications::get(std::string _topic,
...
auto
zpt::apps::datums::MyApplications::query(std::string _topic,
                                         zpt::json _filter,
                                         zpt::ev::emitter _emitter,
                                         zpt::json _identity,
                                         zpt::json _envelope) -> zpt::json {
        ...
        for (auto _d_element : _r_data["elements"]->arr()) {
            zpt::json _d_channels = _emitter->route(
              ...
              { "headers",
                ...
                "params",
                (_envelope["params"] +
                 zpt::json({ "app_id", std::string(_d_element["id"]) })) })["payload"];
            _d_element << "channels"
                       << (_d_channels["elements"]->type() == zpt::JSArray
                             ? _d_channels["elements"]
                             : zpt::json({ zpt::array, _d_channels }));
...
auto
zpt::apps::datums::MyApplications::insert(std::string _topic,
                                          zpt::json _document,
                                          zpt::ev::emitter _emitter,
                                          zpt::json _identity,
                                          zpt::json _envelope) -> zpt::json {
    ...
    std::string _r_id =
      _c->insert("MyApplications", _topic, _document - _r_parent, { "href", _topic });
...
auto
zpt::apps::datums::MyApplications::save(std::string _topic,
                                        zpt::json _document,
                                        zpt::ev::emitter _emitter,
                                        zpt::json _identity,
                                        zpt::json _envelope) -> zpt::json {
    ...
    _r_data = { "href",
                _topic,
                "n_updated",
                _c->save("MyApplications", _topic, _document - _r_parent, { "href", _topic }) };
...
auto
zpt::apps::datums::MyApplications::set(std::string _topic,
                                       zpt::json _document,
                                       zpt::ev::emitter _emitter,
                                       zpt::json _identity,
                                       zpt::json _envelope) -> zpt::json {
    ...
    _r_data = { "href",
                _topic,
                "n_updated",
                _c->set("MyApplications", _topic, _document - _r_parent, { "href", _topic }) };
...
auto
zpt::apps::datums::MyApplications::remove(std::string _topic,
                                          zpt::ev::emitter _emitter,
                                          zpt::json _identity,
                                          zpt::json _envelope) -> zpt::json {
    zpt::json _r_data;
    ...
    zpt::connector _c = _emitter->connector("dbms.mongodb.zpt.apps");
    _r_data = {
        "href", _topic, "n_updated", _c->remove("MyApplications", _topic, { "href", _topic })
    };
...
zpt::apps::datums::MyApplications::remove(std::string _topic,
    ...
    zpt::json _r_elements =
      zpt::apps::datums::MyApplications::query(_topic, _filter, _emitter, _identity, _envelope);
    for (auto _r_element : _r_elements["elements"]->arr()) {
        zpt::apps::datums::MyApplications::remove(
          _r_element["href"]->str(), _emitter, _identity, _envelope);
    }
