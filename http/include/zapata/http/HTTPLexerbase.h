...
class HTTPLexerBase {
	...
	size_t (HTTPLexerBase::*d_get)() = &HTTPLexerBase::getInput;
	...
	enum : size_t { s_rangeOfEOF__ = 44, s_finIdx__ = 45, s_nRules__ = 51, s_maxSizeofStreamStack__ = 10 };
	...
	template <typename ReturnType, typename ArgType> static ReturnType constexpr as(ArgType value);
...
template <typename ReturnType, typename ArgType> inline ReturnType constexpr HTTPLexerBase::as(ArgType value) {
	return static_cast<ReturnType>(value);
}

inline bool HTTPLexerBase::knownFinalState() {
	return (d_atBOL && available(d_final.bol.rule)) || available(d_final.std.rule);
}

inline bool constexpr HTTPLexerBase::available(size_t value) { return value != std::numeric_limits<size_t>::max(); }

inline HTTPLexerBase::StartCondition__ constexpr HTTPLexerBase::SC(int sc) { return as<StartCondition__>(sc); }

inline int constexpr HTTPLexerBase::SC(StartCondition__ sc) { return as<int>(sc); }

inline std::ostream& HTTPLexerBase::out() { return *d_out; }

inline void HTTPLexerBase::push(size_t ch) { d_input.reRead(ch); }

inline void HTTPLexerBase::push(std::string const& str) { d_input.reRead(str, 0); }

inline void HTTPLexerBase::setFilename(std::string const& name) { d_filename = name; }

inline void HTTPLexerBase::setMatched(std::string const& text) { d_matched = text; }

inline std::string const& HTTPLexerBase::matched() const { return d_matched; }

inline HTTPLexerBase::StartCondition__ HTTPLexerBase::startCondition() const { return SC(d_startCondition); }

inline std::string const& HTTPLexerBase::filename() const { return d_filename; }

inline void HTTPLexerBase::echo() const {
	//*d_out << d_matched;
}

inline size_t HTTPLexerBase::length() const { return d_matched.size(); }

inline void HTTPLexerBase::leave(int retValue) const { throw as<Leave__>(retValue); }

inline size_t HTTPLexerBase::lineNr() const { return d_input.lineNr(); }

inline void HTTPLexerBase::more() { d_more = true; }
...
inline size_t HTTPLexerBase::state__() const { return d_state; }

inline size_t HTTPLexerBase::get__() { return (this->*d_get)(); }

inline size_t HTTPLexerBase::getInput() { return d_input.get(); }

inline bool HTTPLexerBase::return__() { return d_return; }

inline void HTTPLexerBase::noReturn__() { d_return = false; }
