...
inline JSONTokenizerBase::DebugMode__
operator|(JSONTokenizerBase::DebugMode__ lhs, JSONTokenizerBase::DebugMode__ rhs) {
    return static_cast<JSONTokenizerBase::DebugMode__>(static_cast<int>(lhs) | rhs);
};

inline bool
JSONTokenizerBase::debug() const {
    return d_debug__;
}

inline bool
JSONTokenizerBase::actionCases() const {
