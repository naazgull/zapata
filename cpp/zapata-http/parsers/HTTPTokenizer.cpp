// Generated by Bisonc++ V4.04.01 on Thu, 03 Apr 2014 18:56:42 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {269, 10}, // 1: exp (METHOD) ->  METHOD #0001 SPACE URL params #0002 SPACE VERSION headers BODY
     {270, 0}, // 2: #0001 ->  <empty>
     {272, 0}, // 3: #0002 ->  <empty>
     {269, 10}, // 4: exp (VERSION) ->  VERSION #0003 SPACE STATUS #0004 SPACE STRING #0005 headers BODY
     {274, 0}, // 5: #0003 ->  <empty>
     {275, 0}, // 6: #0004 ->  <empty>
     {276, 0}, // 7: #0005 ->  <empty>
     {271, 0}, // 8: params ->  <empty>
     {271, 2}, // 9: params (QMARK) ->  QMARK paramslist
     {277, 4}, // 10: paramslist (STRING) ->  STRING #0006 EQ STRING
     {278, 0}, // 11: #0006 ->  <empty>
     {277, 6}, // 12: paramslist (E) ->  paramslist E STRING #0007 EQ STRING
     {279, 0}, // 13: #0007 ->  <empty>
     {273, 3}, // 14: headers (CR_LF) ->  CR_LF headerslist CR_LF
     {280, 6}, // 15: headerslist (STRING) ->  STRING #0008 COLON STRING #0009 CR_LF
     {281, 0}, // 16: #0008 ->  <empty>
     {282, 0}, // 17: #0009 ->  <empty>
     {280, 7}, // 18: headerslist (STRING) ->  headerslist STRING #0010 COLON STRING #0011 CR_LF
     {283, 0}, // 19: #0010 ->  <empty>
     {284, 0}, // 20: #0011 ->  <empty>
     {285, 1}, // 21: exp_$ ->  exp
};
