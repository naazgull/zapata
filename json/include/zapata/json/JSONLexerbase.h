...
class JSONLexerBase {
	...
	size_t (JSONLexerBase::*d_get)() = &JSONLexerBase::getInput;
	...
	enum : size_t { s_rangeOfEOF__ = 48, s_finIdx__ = 49, s_nRules__ = 30, s_maxSizeofStreamStack__ = 10 };
...
template <typename ReturnType, typename ArgType> inline ReturnType constexpr JSONLexerBase::as(ArgType value) {
...
inline JSONLexerBase::StartCondition__ constexpr JSONLexerBase::SC(int sc) { return as<StartCondition__>(sc); }

inline int constexpr JSONLexerBase::SC(StartCondition__ sc) { return as<int>(sc); }
...
inline JSONLexerBase::StartCondition__ JSONLexerBase::startCondition() const { return SC(d_startCondition); }
...
inline void JSONLexerBase::leave(int retValue) const { throw as<Leave__>(retValue); }
...
inline size_t JSONLexerBase::state__() const { return d_state; }

inline size_t JSONLexerBase::get__() { return (this->*d_get)(); }

inline size_t JSONLexerBase::getInput() { return d_input.get(); }

inline bool JSONLexerBase::return__() { return d_return; }

inline void JSONLexerBase::noReturn__() { d_return = false; }
