...
mongo localhost/auth --eval 'db.auth.remove({"role" : "administrator"})' &> /dev/null
mongo localhost/auth --eval 'db.roles.drop()' &> /dev/null
...
mongo localhost/auth --eval 'db.roles.insert({ "_id" : "/0.9/roles/administrator", "href" : "/0.9/roles/administrator", "id" : "administrator", "name" : "Administrator", "scope" : "all{arwx}" })' &> /dev/null
mongo localhost/auth --eval 'db.roles.insert({ "_id" : "/0.9/roles/app-admin", "href" : "/0.9/roles/app-admin", "id" : "app-admin", "name" : "Application Administrator", "scope" : "apps{arwx}" })' &> /dev/null
mongo localhost/auth --eval 'db.roles.insert({ "_id" : "/0.9/roles/user", "href" : "/0.9/roles/user", "id" : "user", "name" : "User", "scope" : "me{arwx},auth{r},roles{r}" })' &> /dev/null
mongo localhost/auth --eval 'db.roles.insert({ "_id" : "/0.9/roles/guest", "href" : "/0.9/roles/guest", "id" : "guest", "name" : "Guest", "scope" : "open" })' &> /dev/null
...
zcli -b tcp://localhost:10009 -t req -m POST -u /0.9/auth -j "{ \"name\" : \"Administrator\", \"username\" : \"root\", \"e-mail\" : \"root@localhost\", \"password\" : \"$password\", \"role\" : \"administrator\" }" -l 0 -r
