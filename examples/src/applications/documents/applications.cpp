...
auto
zpt::apps::documents::applications::restify(zpt::ev::emitter _emitter) -> void {
    _emitter->on(
      ...
      { { zpt::ev::Get,
          [](zpt::performative _performative,
             ...
             zpt::ev::emitter _emitter) -> zpt::json {
              ...
              zpt::json _identity = zpt::rest::authorization::validate(
                "/v2/datums/applications/{id}", _envelope, _emitter);

              zpt::json _r_body;
              _r_body =
                zpt::apps::datums::Applications::get(_topic, _emitter, _identity, _envelope);
        ...
        { zpt::ev::Put,
          [](zpt::performative _performative,
             ...
             zpt::ev::emitter _emitter) -> zpt::json {
              ...
              zpt::json _r_body;
              _r_body = zpt::apps::datums::Applications::save(
