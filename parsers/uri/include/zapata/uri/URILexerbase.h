...
inline size_t URILexerBase::Input::lineNr() const { return d_lineNr; }
inline size_t URILexerBase::Input::nPending() const { return d_deque.size(); }
inline void URILexerBase::Input::setPending(size_t size) {
    d_deque.erase(d_deque.begin(), d_deque.end() - size);
}
inline void URILexerBase::Input::close() {
    delete d_in;
