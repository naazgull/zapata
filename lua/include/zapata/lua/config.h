/* include/zapata/lua/config.h.  Generated from config.h.in by configure.  */
/* include/zapata/lua/config.h.in.  Generated from configure.ac by autoheader.  */

#include <zapata/lua/unconfig.h>
...
/* Define to 1 if you have the `lua3.6m' library (-llua3.6m). */
/* #undef HAVE_LIBPYTHON3_6M */
...
/* Name of package */
#define PACKAGE "zapata-lua"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "n@zgul <n@zgul.me>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "zapata-lua"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "zapata-lua 1.0.0-1artful1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zapata-lua"
