...
// hdr/abort
inline void URITokenizerBase::ABORT() const { throw PARSE_ABORT_; }

// hdr/accept
inline void URITokenizerBase::ACCEPT() const { throw PARSE_ACCEPT_; }

// hdr/error
inline void URITokenizerBase::ERROR() const { throw UNEXPECTED_TOKEN_; }

// hdr/savedtoken
inline int URITokenizerBase::savedToken_() const { return d_next.first; }
...
// hdr/recovery
inline bool URITokenizerBase::recovery_() const { return d_recovery; }

// hdr/stacksize
inline size_t URITokenizerBase::stackSize_() const { return d_stackIdx + 1; }

// hdr/state
inline size_t URITokenizerBase::state_() const { return d_state; }

// hdr/token
inline int URITokenizerBase::token_() const { return d_token; }

// hdr/vs
inline URITokenizerBase::STYPE_& URITokenizerBase::vs_(int idx) { return (d_vsp + idx)->second; }
