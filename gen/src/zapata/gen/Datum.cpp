...
auto $[namespace]::$[datum.name]::get(std::string _topic, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::query(std::string _topic, zpt::json _filter, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::insert(std::string _topic, zpt::json _document, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::save(std::string _topic, zpt::json _document, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::set(std::string _topic, zpt::json _document, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::set(std::string _topic, zpt::json _document, zpt::json _filter, zpt::ev::emitter _emitter) -> zpt::json {
	zpt::connector _c = _emitter->connector("$[datum.method.set.client]");
...
auto $[namespace]::$[datum.name]::remove(std::string _topic, zpt::ev::emitter _emitter) -> zpt::json {
...
auto $[namespace]::$[datum.name]::remove(std::string _topic, zpt::json _filter, zpt::ev::emitter _emitter) -> zpt::json {
	zpt::connector _c = _emitter->connector("$[datum.method.remove.client]");
