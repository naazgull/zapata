...
auto
zpt::apps::collections::channels::restify(zpt::ev::emitter _emitter) -> void {
    _emitter->on(
          ...
          [](zpt::performative _performative,
             ...
             zpt::ev::emitter _emitter) -> zpt::json {
              ...
              zpt::json _identity = zpt::rest::authorization::validate(
                "/v2/datums/applications/{app_id}/users/{user_id}/channels", _envelope, _emitter);
              ...
              return _emitter->route(
                ...
                { "headers",
                  ...
                  "params",
                  (_envelope["params"] +
                   zpt::json({ "app_id", _tv_app_id, "user_id", _tv_user_id })) });
          } },
        { zpt::ev::Post,
          [](zpt::performative _performative,
             std::string _topic,
