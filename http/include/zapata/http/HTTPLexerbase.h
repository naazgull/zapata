...
inline HTTPLexerBase::StartCondition__ constexpr HTTPLexerBase::SC(int sc) {
    return as<StartCondition__>(sc);
}

inline int constexpr HTTPLexerBase::SC(StartCondition__ sc) {
    return as<int>(sc);
}
...
inline HTTPLexerBase::StartCondition__
...
inline bool
HTTPLexerBase::return__() {
    return d_return;
}

inline void
HTTPLexerBase::noReturn__() {
    d_return = false;
}
