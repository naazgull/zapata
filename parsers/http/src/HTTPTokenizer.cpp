// Generated by Bisonc++ V6.08.00 on Wed, 28 May 2025 15:17:18 +0100
...
PI_ const s_productionInfo[] = {
    ...
    { 267, 10 }, // 1: exp (METHOD) ->  METHOD #0001 SPACE resource #0002 SPACE PROTOCOL_VERSION
                 // #0003 headers rest
    { 268, 0 },  // 2: #0001 ->  <empty>
    { 270, 0 },  // 3: #0002 ->  <empty>
    { 272, 0 },  // 4: #0003 ->  <empty>
    { 267, 8 },  // 5: exp (PROTOCOL_VERSION) ->  PROTOCOL_VERSION #0004 SPACE STATUS #0005
                 // status_description headers rest
    { 274, 0 },  // 6: #0004 ->  <empty>
    { 276, 0 },  // 7: #0005 ->  <empty>
    { 269, 1 },  // 8: resource (URL) ->  URL
    { 269, 1 },  // 9: resource (STAR) ->  STAR
    { 275, 0 },  // 10: status_description ->  <empty>
    { 275, 2 },  // 11: status_description (SPACE) ->  SPACE STRING
    { 271, 3 },  // 12: headers (CR_LF) ->  CR_LF headerslist CR_LF
    { 271, 2 },  // 13: headers (CR_LF) ->  CR_LF headerslist
    { 277, 4 },  // 14: headerslist (STRING) ->  STRING #0006 COLON STRING
    { 278, 0 },  // 15: #0006 ->  <empty>
    { 277, 6 },  // 16: headerslist (CR_LF) ->  headerslist CR_LF STRING #0007 COLON STRING
    { 279, 0 },  // 17: #0007 ->  <empty>
    { 273, 1 },  // 18: rest (BODY) ->  BODY
    { 273, 0 },  // 19: rest ->  <empty>
    { 280, 1 },  // 20: exp_$ ->  exp
};
...
SR_ const* s_state[] = {
    ...
    s_24, s_25, s_26, s_27, s_28, s_29, s_30, s_31, s_32, s_33, s_34, s_35,
};
