...
PI_ const s_productionInfo[] = {
    ...
    { 261, 2 }, // 1: exp (TOKEN) ->  TOKEN params
    { 262, 0 }, // 2: params ->  <empty>
    { 262, 3 }, // 3: params (LPAREN) ->  LPAREN param_list RPAREN
    { 263, 0 }, // 4: param_list ->  <empty>
    { 263, 2 }, // 5: param_list ->  exp param_list
    { 263, 3 }, // 6: param_list (COMMA) ->  COMMA exp param_list
    { 264, 1 }, // 7: exp_$ ->  exp
};
