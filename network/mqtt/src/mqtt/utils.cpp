...
zpt::mqtt::utils::check_err(int _return,
    ...
    switch (_return) {
        case MOSQ_ERR_ERRNO:
            ...
            break;
        case MOSQ_ERR_INVAL:
            _error_description = "input parameters were invalid";
            break;
        case MOSQ_ERR_NOMEM:
        ...
        case MOSQ_ERR_CONN_REFUSED:
            _error_description = "MOSQ_ERR_CONN_REFUSED";
            break;
        case MOSQ_ERR_NOT_FOUND:
            _error_description = "MOSQ_ERR_NOT_FOUND";
            break;
        case MOSQ_ERR_TLS:
            _error_description = "MOSQ_ERR_TLS";
            break;
        case MOSQ_ERR_PAYLOAD_SIZE:
            _error_description = "MOSQ_ERR_PAYLOAD_SIZE";
            break;
        case MOSQ_ERR_NOT_SUPPORTED:
            _error_description = "MOSQ_ERR_NOT_SUPPORTED";
            break;
        case MOSQ_ERR_AUTH:
            _error_description = "MOSQ_ERR_AUTH";
            break;
        case MOSQ_ERR_ACL_DENIED:
            _error_description = "MOSQ_ERR_ACL_DENIED";
            break;
        case MOSQ_ERR_UNKNOWN:
            _error_description = "MOSQ_ERR_UNKNOWN";
            break;
        case MOSQ_ERR_EAI:
            _error_description = "MOSQ_ERR_EAI";
            break;
        case MOSQ_ERR_PROXY:
            _error_description = "MOSQ_ERR_PROXY";
            break;
        default:
