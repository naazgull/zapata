// Generated by Bisonc++ V6.03.00 on Fri, 24 Jul 2020 18:10:55 -44322510
...
PI_ const s_productionInfo[] = {
    ...
    { 269, 3 }, // 3: scheme (STRING) ->  STRING #0001 DOUBLE_DOT
    { 273, 0 }, // 4: #0001 ->  <empty>
    { 270, 2 }, // 5: object ->  server path
    { 270, 1 }, // 6: object ->  path
    { 274, 6 }, // 7: server (SLASH) ->  SLASH SLASH user STRING #0002 port
    { 278, 0 }, // 8: #0002 ->  <empty>
    { 274, 5 }, // 9: server (SLASH) ->  SLASH SLASH STRING #0003 port
    { 279, 0 }, // 10: #0003 ->  <empty>
    { 276, 3 }, // 11: user (STRING) ->  STRING #0004 AT
    { 280, 0 }, // 12: #0004 ->  <empty>
    { 277, 0 }, // 13: port ->  <empty>
    { 277, 2 }, // 14: port (DOUBLE_DOT) ->  DOUBLE_DOT STRING
    { 275, 0 }, // 15: path ->  <empty>
    { 275, 1 }, // 16: path (SLASH) ->  SLASH
    { 275, 4 }, // 17: path (SLASH) ->  SLASH STRING #0005 path
    { 281, 0 }, // 18: #0005 ->  <empty>
    { 275, 3 }, // 19: path (DOT) ->  DOT #0006 path
    { 282, 0 }, // 20: #0006 ->  <empty>
    { 275, 3 }, // 21: path (DOT_DOT) ->  DOT_DOT #0007 path
    { 283, 0 }, // 22: #0007 ->  <empty>
    { 271, 0 }, // 23: params ->  <empty>
    { 271, 2 }, // 24: params (QMARK) ->  QMARK paramslist
    { 284, 4 }, // 25: paramslist (STRING) ->  STRING #0008 EQ paramvalue
    { 285, 0 }, // 26: #0008 ->  <empty>
    { 284, 6 }, // 27: paramslist (E) ->  paramslist E STRING #0009 EQ paramvalue
    { 287, 0 }, // 28: #0009 ->  <empty>
    { 286, 0 }, // 29: paramvalue ->  <empty>
    { 286, 3 }, // 30: paramvalue (STRING) ->  STRING #0010 function_parameters
    { 289, 0 }, // 31: #0010 ->  <empty>
    { 288, 0 }, // 32: function_parameters ->  <empty>
    { 288,
      3 }, // 33: function_parameters (FUNCTION_PARAM) ->  FUNCTION_PARAM #0011 function_parameters
    { 290, 0 }, // 34: #0011 ->  <empty>
    { 272, 0 }, // 35: anchor ->  <empty>
    { 272, 2 }, // 36: anchor (CARDINAL) ->  CARDINAL STRING
    { 291, 1 }, // 37: exp_$ ->  exp
};
...
SR_ const s_51[] = {
    { { REQ_DEF }, { 3 } },
    { { 288 }, { 53 } }, // function_parameters
    { { 264 }, { 54 } }, // FUNCTION_PARAM
    { { 0 }, { -32 } },
};
...
// State array:
SR_ const* s_state[] = {
    s_0,  s_1,  s_2,  s_3,  s_4,  s_5,  s_6,  s_7,  s_8,  s_9,  s_10, s_11, s_12, s_13, s_14,
    s_15, s_16, s_17, s_18, s_19, s_20, s_21, s_22, s_23, s_24, s_25, s_26, s_27, s_28, s_29,
    s_30, s_31, s_32, s_33, s_34, s_35, s_36, s_37, s_38, s_39, s_40, s_41, s_42, s_43, s_44,
    s_45, s_46, s_47, s_48, s_49, s_50, s_51, s_52, s_53, s_54, s_55, s_56,
};
