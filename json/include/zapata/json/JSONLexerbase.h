...
inline size_t JSONLexerBase::state_() const
{
    return d_state;
}

inline size_t JSONLexerBase::get_()
{
    return (this->*d_get)();
}

inline size_t JSONLexerBase::getInput()
{
    return d_input.get();
}

inline bool JSONLexerBase::return_()
{
    return d_return;
}

inline void JSONLexerBase::noReturn_()
{
    d_return = false;
}
