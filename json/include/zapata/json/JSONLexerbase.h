...
inline JSONLexerBase::StartCondition__ constexpr JSONLexerBase::SC(int sc) {
    return as<StartCondition__>(sc);
}

inline int constexpr JSONLexerBase::SC(StartCondition__ sc) {
    return as<int>(sc);
}
...
inline JSONLexerBase::StartCondition__
...
inline bool
JSONLexerBase::return__() {
    return d_return;
}

inline void
JSONLexerBase::noReturn__() {
    d_return = false;
}
