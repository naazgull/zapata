// Generated by Bisonc++ V6.02.05 on Sat, 04 Apr 2020 02:22:12 +0100
...
PI_ const s_productionInfo[] = {
    ...
    { 270, 0 }, // 5: #0001 ->  <empty>
    { 267, 4 }, // 6: server (SLASH) ->  SLASH SLASH user STRING
    { 267, 3 }, // 7: server (SLASH) ->  SLASH SLASH STRING
    { 271, 3 }, // 8: user (STRING) ->  STRING #0002 AT
    { 272, 0 }, // 9: #0002 ->  <empty>
    { 271, 6 }, // 10: user (STRING) ->  STRING #0003 DOUBLE_DOT STRING #0004 AT
    { 273, 0 }, // 11: #0003 ->  <empty>
    { 274, 0 }, // 12: #0004 ->  <empty>
    { 268, 0 }, // 13: path ->  <empty>
    { 268, 1 }, // 14: path (SLASH) ->  SLASH
    { 268, 4 }, // 15: path (SLASH) ->  SLASH STRING #0005 path
    { 275, 0 }, // 16: #0005 ->  <empty>
    { 269, 0 }, // 17: params ->  <empty>
    { 269, 2 }, // 18: params (QMARK) ->  QMARK paramslist
    { 276, 4 }, // 19: paramslist (STRING) ->  STRING #0006 EQ paramvalue
    { 277, 0 }, // 20: #0006 ->  <empty>
    { 276, 6 }, // 21: paramslist (E) ->  paramslist E STRING #0007 EQ paramvalue
    { 279, 0 }, // 22: #0007 ->  <empty>
    { 278, 0 }, // 23: paramvalue ->  <empty>
    { 278, 3 }, // 24: paramvalue (STRING) ->  STRING #0008 function_parameters
    { 281, 0 }, // 25: #0008 ->  <empty>
    { 280, 0 }, // 26: function_parameters ->  <empty>
    { 280,
      3 }, // 27: function_parameters (FUNCTION_PARAM) ->  FUNCTION_PARAM #0009 function_parameters
    { 282, 0 }, // 28: #0009 ->  <empty>
    { 283, 1 }, // 29: exp_$ ->  exp
};
...
SR_ s_36[] = {
    { { REQ_DEF }, { 3 } },
    { { 280 }, { 39 } }, // function_parameters
    { { 264 }, { 40 } }, // FUNCTION_PARAM
    { { 0 }, { -26 } },
};
...
SR_* s_state[] = {
    ...
    s_30, s_31, s_32, s_33, s_34, s_35, s_36, s_37, s_38, s_39, s_40, s_41, s_42, s_43,
};
